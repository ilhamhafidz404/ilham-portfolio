export default function QuoteCard() {
  return (
    <div className="card shadow-xl shadow-[#d65d26]/30 p-5 rounded relative card-about w-80 mx-auto bg-white/50">
      <p className="m-5 text-center text-gray-600 text-about myfont-montserrat dark:text-gray-100">
      ...
      <div className="ilham-circle-img w-16 h-16 mybg-primary mx-auto rounded-full bg-cover bg-center mt-10 border"></div>
